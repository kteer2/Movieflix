...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan("mywebapp.movieflix.entities");
	...
	private Properties jpaProperties() {
		...
		props.setProperty(PersistenceUnitProperties.DDL_GENERATION, PersistenceUnitProperties.CREATE_OR_EXTEND);//CREATE_OR_EXTEND);//
