...
(function() {
  ...
  function Moviectrl($location) {
    var mVm = this;
    mVm.name = 'World!!';

    mVm.profile = 'This is my super profile';

    mVm.goToDetails = function() {

      $location.path('/viewmoviedetails');
    };

    mVm.goToMain = function() {

      $location.path('/viewmovies');
    };
    mVm.goToHome = function() {
    ...
    mVm.calledByDirective = function(data) {
  ...
  function mfTile() {
    ...
    return {
      ...
      restrict: 'E',
      templateUrl: 'viewmovies-dir.html',
      link: function(scope, elem, attr) {
        var ip = elem.find('input');
